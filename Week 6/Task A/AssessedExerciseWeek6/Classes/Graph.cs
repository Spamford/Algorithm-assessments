...
namespace AssessedExerciseWeek6.Classes
{
        public class Graph
        {
        ...
        public LinkedList<GraphNode> nodesList()
        {
            return nodes;
        }
            ...
            // check if the graph is empty (no node is present) and return true if the graph is empty, otherwise return false
